...
templatesRouter.get('/', async (req:express.Request,res:express.Response) => {
    const { title, author, links } = {
        ...
        links:{
            documentation:'https://shop-api-production-d2b7.up.railway.app/docs',
            ...
            personalPhoto:'https://media.licdn.com/dms/image/D4D03AQHSeXRiylDCHw/profile-displayphoto-shrink_800_800/0/1676066821987?e=1685577600&v=beta&t=uK9STFIeb2AiwLnn6NWuo0apGy1WNVe4kHDNJDqueic',
